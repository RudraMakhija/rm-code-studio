...
async function PricingPage() {
  ...
  return (
    ...
    >
      ...
      <main className="relative pt-8 pb-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              ...
              >
                Code Without Limits <br />
                Go Pro
              </h1>
            </div>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Pro gives you unrestricted access to all the 10 languages
            </p>
          </div>
            ...
            <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="text-center mb-12">
                  ...
                  <p className="text-gray-400 text-lg">Unlock the full potential of RM Code Studio</p>
                </div>
